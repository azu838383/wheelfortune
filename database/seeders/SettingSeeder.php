...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $postCat = [
            [
                'set_for' => 'seo_title',
                'value' => 'BetKK Spining Wheel Fortune',
                'updated_by' => 1,
            ...
            [
                ...
                'value' => 'betkk, spining, fortune, buah4d, ransjitu,',
                'updated_by' => 1,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                ...
                'value' => 'BetKK Spining Wheel Fortune is apps for share reward to player',
                'updated_by' => 1,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
