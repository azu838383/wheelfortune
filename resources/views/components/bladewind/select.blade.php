...
<div class="relative bw-select bw-select-{{$input_name}} @if($add_clearing) mb-3 @endif"
    ...
    <div class="flex justify-between text-sm items-center rounded-md !bg-inherit text-slate-600 border-2 border-slate-300/50
    ...
    <div class="w-full absolute z-30 rounded-br-lg rounded-bl-lg bg-white shadow-sm shadow-slate-400 border-2 
        ...
        hidden bw-select-items-container overflow-y-none max-h-64 animate__animated animate__fadeIn animate__faster">
